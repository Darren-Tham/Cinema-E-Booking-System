...
public class CustomerController {
  ...
  public ResponseEntity<String> getEmailByCustomerId(
  ...
  @GetMapping("/id/{email}")
  public ResponseEntity<Integer> getCustomerIdByEmail(
  ...
  public ResponseEntity<Integer> login(
    ...
    final int customerId = customerService.getCustomerIdByEmailAndPassword(
      email,
      password
    );
    return ResponseEntity.ok(customerId);
  ...
  @PostMapping("/add")
  public ResponseEntity<Integer> addInactiveCustomer(
    @RequestBody final InactiveCustomerDTO customer
  ) {
  ...
  public ResponseEntity<String> setStatusToActive(
    @PathVariable final int customerId
  ) {
    customerService.setStatusToActive(customerId);
    final String msg = String.format(
      "The status of the customer with id %d has been changed to ACTIVE.",
      customerId
    );
  ...
  @PutMapping("/edit_profile/{customerId}")
  public ResponseEntity<String> editProfile(
    @PathVariable final int customerId,
    @RequestBody final CustomerDTO customer
  ) {
    customerService.editProfile(customerId, customer);
